      ...
      actions: [
        {
          ...
          onSelect: () => openLink("https://github.com/xiud-dev"),
        },
        {
          title: "Instagram",
          icon: <IconBrandInstagram size={16} className="mr-2" />,
          onSelect: () =>
            openLink("https://www.instagram.com/1.345678902346723984"),
        },
        {
          title: "Medium",
          icon: <IconBrandMedium size={16} className="mr-2" />,
          onSelect: () => openLink("https://medium.com/@locyan0825"),
        },
        {
          title: "LinkedIn",
          icon: <IconBrandLinkedin size={16} className="mr-2" />,
          onSelect: () =>
            openLink("https://www.linkedin.com/in/loch-yan"),
        },
      ],
    },
  ];
