export const experiences = [
  {
    ...
    location: "Remote (Greenville, South Carolina)",
    link: { url: "https://designli.co/", label: "designli" },
    logo: "/images/exp/designli.webp",
  },
  {
    title: "Full Stack Engineer",
    company: "AppDvantix",
    ...
    description: [
      "Constructed scalable web applications with Node.js and React, achieving a 50% reduction in load times and enhancing experience for over 10,000 active users.",
      "Integrated RESTful APIs and microservices, improving system performance by 30% and enabling seamless third-party service integration.",
      "Designed and optimized database solutions across MySQL, PostgreSQL, and MongoDB, resulting in a 25% increase in data retrieval efficiency and a 15% reduction in operational costs.",
      "Collaborated with teams to create a mobile application using React Native, achieving a 40% increase in user engagement and a 20% boost in downloads within the first quarter.",
      "Directed the migration of legacy systems to cloud platforms (AWS and Azure), enhancing reliability and scalability, resulting in a 35% decrease in downtime.",
      "Conducted code reviews and enforced best practices, improving code quality and reducing bugs by 40%, contributing to a more stable release cycle.",
      "Provided IT consulting services, identifying technology solutions that increased operational efficiency by 20%.",
    ],
    location: "Remote (San Francisco, California)",
    link: { url: "https://appdvantix.com/", label: "AppDvantix" },
    logo: "/images/exp/appdvantix.webp",
  },
  {
    ...
    link: {
      url: "https://grayphite.com/",
      label: "Grayphite",
    },
    logo: "/images/exp/grayphite.webp",
  },
];
